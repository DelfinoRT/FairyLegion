...
const bossRaidData = [
    ...
    { name: "Palkia", region: "South Mandarin City", location: "Este Olivine, Isla Dragón", imagePath: "BossRaids/palkia.png", groupA: ["TM Dragon Storm", "TM Outrage"], groupB: ["TM Dragon Lullaby", "Surf"], groupC: ["TM Dragon Claw", "Palkia Toy", "Palkia Carpet"] },
    { name: "Dialga", region: "South Mandarin City", location: "Este Olivine, Isla Dragón", imagePath: "BossRaids/dialga.png", groupA: ["TM Case 14", "Dusty Box", "Blue Box"], groupB: ["TM Metal Burst", "TM Metallic Noise"], groupC: ["Dialga Carpet", "Dialga Toy"] },
    ...
    { name: "Kyogre", region: "Hoenn", location: "Sootopolis City (Bucea al Sur del gimnasio)", imagePath: "BossRaids/kyogre.png", groupA: ["TM Case 21", "TM Rain Dance", "TM Liquidation", "Big Shrimp Bait"], groupB: ["TM Water Pulse", "TM Surf"], groupC: ["Kyogre Carpet", "Kyogre Toy"] },
    { name: "Manaphy", region: "Hoenn", location: "Sootopolis City (Bucea al Sur del gimnasio)", imagePath: "BossRaids/manaphy.png", groupA: ["Pokemon: Phione", "TM Case 20", "Cold Box"], groupB: ["TM Brine", "TM Liquidation"], groupC: ["TM Surf", "Manaphy Carpet", "Phione Carpet"] },
    ...
    { name: "Hoopa Unbound", region: "Hoenn", location: "Noroeste de Fallarbor City (primera isla a la izquierda)", imagePath: "BossRaids/hoopa.png", groupA: ["TM Reflect", "TM Shadow Storm", "Life Orb"], groupB: ["TM Grudge", "TM Power Split", "Trapped Black Soul"], groupC: ["psy/ghost items"] },
