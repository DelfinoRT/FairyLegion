...
const bossRaidData = [
    ...
    // HOENN REGION BOSSES
    { name: "Latias", region: "Hoenn", location: "Noreste de Lilycove City", imagePath: "BossRaids/latias_latios.png", groupA: ["TM Case 16", "TM Dragon Cry", "TM Wonder Room"], groupB: ["TM Draco Pulse"], groupC: ["TM Dragon Pulse", "Latias Carpet", "Latias Toy"] },
    { name: "Latios", region: "Hoenn", location: "Noreste de Lilycove City", imagePath: "BossRaids/latias_latios.png", groupA: ["TM Case 17", "TM Twister", "TM Psychic Terrain"], groupB: ["TM Clanging Scales"], groupC: ["TM Dragon Pulse", "Latios Carpet", "Latios Toy"] },
    ...
    { name: "Primal Groudon", region: "Hoenn", location: "Noroeste de Lavaridge City (encuentra un agujero)", imagePath: "BossRaids/groudon_primal_groudon.png", groupA: ["(No hay datos para grupo A)"], groupB: ["(No hay datos para grupo B)"], groupC: ["(No hay datos para grupo C)"] }, // No data provided for Primal Groudon
